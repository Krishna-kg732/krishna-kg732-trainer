...
## [v99.0.2](https://github.com/kubeflow/trainer/releases/tag/v99.0.2) (2026-02-27)

This is Kubeflow Trainer v99.0.2 release.

```bash
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/manager?ref=v99.0.2"
kubectl apply --server-side -k "https://github.com/kubeflow/trainer.git/manifests/overlays/runtimes?ref=v99.0.2"
```

You can now install controller manager with Helm charts 🚀

```bash
helm install kubeflow-trainer oci://ghcr.io/kubeflow/charts/kubeflow-trainer --version 99.0.2
```
...
## [v99.0.1](https://github.com/kubeflow/trainer/releases/tag/v99.0.1) (2026-02-27)
...
- chore(release): Release v99.0.1 (@krishna-kg732)
...
## [v99.0.0](https://github.com/kubeflow/trainer/releases/tag/v99.0.0) (2026-02-26)
